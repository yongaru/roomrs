...
# vcpkg_build_nmake는 nmake target을 올바르게 처리하지 못한다.
...
list(APPEND NMAKE_OPTIONS
    ...
    EXT_FEATURE_FLAGS=-DSQLITE_TEMP_STORE=2\ -DSQLITE_HAS_CODEC\ -DSQLITE_ENABLE_PREUPDATE_HOOK
)

set(ENV{INCLUDE} "${CURRENT_INSTALLED_DIR}/include;$ENV{INCLUDE}")

# SQLCipher SQLite amalgamation을 생성한다.
